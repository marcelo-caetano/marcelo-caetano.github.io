...
%
%   POWMAG = LIN2POW(LINMAG,POW,NANFLAG) uses the logical flag NANFLAG to 
%   handle the case POWMAG = Inf commonly resulting from POW < 0 when 
%   LINMAG contains values approaching 0. NANFLAG = TRUE replaces Inf with 
%   REALMAX in POWMAG. NANFLAG = FALSE ignores Inf in POWMAG. Use 
%   NANFLAG = TRUE to get numeric values in POWMAG. NANFLAG defaults to 
%   FALSE for the syntax above.
%
