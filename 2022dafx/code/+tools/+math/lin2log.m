...
%   log2.
%
%   LOGMAG = LIN2LOG(LINMAG,LOGFLAG,NANFLAG) uses the logical flag NANFLAG
%   to handle the case LINMAG = 0. NANFLAG = TRUE replaces 0 with eps(0) to
%   avoid -Inf in LOGMAG. NANFLAG = FALSE ignores 0 in LINMAG. Use NANFLAG =
%   TRUE to get numeric values in LOGMAG. NANFLAG defaults to FALSE when
%   LIN2LOG is called with only two input arguments.
%
