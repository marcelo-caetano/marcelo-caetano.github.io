...
%   PMS = FFT2POW_MAG_SPEC(FFT) retuns the power magnitude spectrum PMS of
%   the full frequency range of the complex FFT vector or matrix. FFT is
%   size NFFT x NFRAME x NCHANNEL, where NFFT is the FFT size, NFRAME is
%   the number of frames of the STFT, and NCHANNEL is the number of audio
%   channels of the original signal S transformed with the STFT.
%   NCHANNEL = 1 for mono, NCHANNEL = 2 for stereo, and so on. FFT is a
%   colum vector when NFRAME = 1 and NCHANNEL = 1. PMS will have the same
