function [amp,freq,ph,center_frame,npartial,nframe,nchannel,nsample,dc] = sinusoidal_analysis(wav,framelen,hop,nfft,fs,...
    ...
    harmselflag,ref0,tvarf0flag,maxharmdev,harmthres,harmpartflag)
...
elseif nargin == 24
    ...
    [ref0,tvarf0flag,maxharmdev,harmthres,harmpartflag] =...
        defaults{20:end};
    
elseif nargin == 25
    
    [tvarf0flag,maxharmdev,harmthres,harmpartflag] =...
        defaults{21:end};
    
elseif nargin == 26
    
    [maxharmdev,harmthres,harmpartflag] =...
        defaults{22:end};
    
elseif nargin == 27
    
    [harmthres,harmpartflag] = defaults{23:end};
...
elseif ptrackflag && ~trackdurflag && harmselflag
    ...
    [amp,freq,ph,npartial] = harmonic_selection(amplitude,frequency,phase,...
        npartial,nframe,nchannel,ref0,maxharmdev,harmthres,'part',harmpartflag,tvarf0flag);
...
elseif ~ptrackflag && harmselflag
    ...
    [amp,freq,ph,npartial] = harmonic_selection(amplitude,frequency,phase,...
        maxnpeak,nframe,nchannel,ref0,maxharmdev,harmthres,'peak',harmpartflag,tvarf0flag);
