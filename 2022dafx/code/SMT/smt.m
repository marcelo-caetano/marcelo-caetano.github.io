...
[sin_harm_morph,part_harm_morph,amp_part_morph,freq_part_morph,phase_part_morph] = sinusoidal_resynthesis(interp_amp,interp_freq,interp_ph,...
    framelen,hop,fs_morph,winflag,'non',cframe_morph,npartial_morph,nframe_morph,nchannel_morph,nsample_morph,'PRFI',...
    ptrackflag,ptrackalgflag,max_harm_dev,trackdurflag,durthres,gapthres,dispflag);
