function [ampCurrNew,ampNextNew,freqCurrNew,freqNextNew,phaseCurrNew,phaseNextNew,ideath,ibirth,imatch,iempty] = ...
    partial_matching(ampCurr,ampNext,freqCurr,freqNext,phaseCurr,phaseNext,npartial,delta)
%PEAK MATCHING Match parameters of spectral peaks between consecutive
%frames
%
%   [CAm,NAm,CFm,NFm,CPm,NPm] = PARTIAL_MATCHING(CA,NA,CF,NF,CP,NP,delta,tools.dsp.hopsize,sr)
